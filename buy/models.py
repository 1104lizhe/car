...
class Cart(models.Model):
    susers = models.ForeignKey(UserInfo, on_delete=models.CASCADE, verbose_name='买家')
...
class Orders(models.Model):
    sale_users = models.ForeignKey(UserInfo, on_delete=models.CASCADE, related_name='suser', verbose_name='卖家')
    buy_users = models.ForeignKey(UserInfo, on_delete=models.CASCADE, related_name='buser', verbose_name='买家')
    brand = models.CharField(max_length=30, null=False, verbose_name='车辆信息')
    picture = models.ImageField(default='normal.png', verbose_name='照片')
    price = models.CharField(max_length=30, null=False, verbose_name='成交价格')
    newprice = models.CharField(max_length=30, null=False, verbose_name='新车价格')
